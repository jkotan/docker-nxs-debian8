...
RUN apt-get -qq update && apt-get -qq install libc6  libcos4-1 libgcc1  libomniorb4-1 libomnithread3c2 libstdc++6 libzmq3 zlib1g python-tz python-six python-numpy python-qt4
